...
const ALL_IMAGES = [
  '491527617.webp', '491527770.webp', '156069210.webp', '156075390.webp',
  '84407726.webp', '84407771.webp', '84407930.webp', '84408390.webp',
  '84406659.webp', '84406304.webp', '84406136.webp', '84405917.webp',
  '84404779.webp', '84403951.webp', '84403059.webp', '84402925.webp',
  '84402427.webp', '84409304.webp', '84417111.webp', '84416173.webp',
  '84407130.webp', '84407801.webp', '84408134.webp', '84406283.webp',
  '63819163.webp', '63819159.webp', '63819154.webp', '63819153.webp',
  '63817464.webp', '63817462.webp', '43318575.webp', '43318574.webp',
  '43318573.webp', '43318572.webp', '43318567.webp', '43318566.webp',
  '43318563.webp', '43318559.webp', '43318548.webp', '43318538.webp',
  '43318519.webp', '43318518.webp', '43318517.webp',
]
...
export default function Gallery() {
  ...
  const displayed = showAll ? ALL_IMAGES : ALL_IMAGES.slice(0, PREVIEW_COUNT)

  const closeLightbox = useCallback(() => setLightbox(null), [])
  const prevImg = useCallback(() =>
    setLightbox(p => p === null ? null : p === 0 ? ALL_IMAGES.length - 1 : p - 1), [])
  const nextImg = useCallback(() =>
    setLightbox(p => p === null ? null : p === ALL_IMAGES.length - 1 ? 0 : p + 1), [])
    ...
    <>
      <section id="gallery" className="section-padding bg-[var(--color-sand-50)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Show more */}
          {!showAll && ALL_IMAGES.length > PREVIEW_COUNT && (
            <div className="text-center mt-10">
              ...
              >
                + {ALL_IMAGES.length - PREVIEW_COUNT} {t.gallery.photo}
              </button>
            </div>
          )}
        </div>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={`/images/${ALL_IMAGES[lightbox]}`}
                  alt={`Villa Mare Mar ${lightbox + 1}`}
                  style={{
                    maxWidth: '100%',
                    maxHeight: '85vh',
                    width: 'auto',
