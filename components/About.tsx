        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="absolute top-4 left-4 bg-white rounded-xl shadow-lg px-4 py-3 flex flex-col items-center">
                ...
                <div className="flex gap-0.5 mt-1">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
                      className="w-3 h-3 text-[var(--color-sand-500)]"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
          ...
          <div className="flex flex-col gap-6">
            ...
            <AnimatedSection delay={0.25}>
              <p className="text-gray-600 leading-relaxed text-base">{t.about.text1}</p>
            </AnimatedSection>

            <AnimatedSection delay={0.35}>
              <p className="text-gray-600 leading-relaxed text-base">{t.about.text2}</p>
            </AnimatedSection>

            <AnimatedSection delay={0.45}>
              <p className="text-gray-600 leading-relaxed text-base">{t.about.text3}</p>
            </AnimatedSection>
              ...
              <div className="grid grid-cols-2 gap-3 mt-2">
                {t.about.features.map((feature, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-semibold text-[var(--color-sea-800)]">
                      {feature}
                    </span>
                  </div>
                ))}
